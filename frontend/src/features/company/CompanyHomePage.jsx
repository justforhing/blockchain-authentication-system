  ...
  return (
    <div className="container mx-auto my-8 p-8 bg-gray-100 border rounded-md shadow-lg">
         <div className="flex justify-center items-center">
          <Link className="text-3xl font-bold text-blue-700 mb-4 mx-auto flex" to={"/"}> 回到主页 <IoIosHome className="ml-3" />
</Link>
          </div> 

      {web3 ? (
        <div>
          <h2 className="text-2xl font-bold mb-4">连接账户: {account}</h2>
          <h2 className="text-2xl font-bold mb-4">钱包余额: {balance} ETH</h2>
          <h2 className="text-2xl font-bold mb-4">智能合约地址: {contractAddress}</h2>
          ...
          <div className="mb-4">
            ...
            {companyName ? (
              ...
              <div className="flex itEther Amountems-center">
                <input
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700">以太币数量:</label>
            <input
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700">以太币单位:</label>
            <select
              className="mt-1 p-2 border rounded-md w-full"
              value={etherUnit}
